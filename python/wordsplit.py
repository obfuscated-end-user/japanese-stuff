...
sample_text1 = "外法、奉る、傍観、粛正、遠心力、枠組み、風貌、駄菓子、鶴の一声、火炎、映える、惨敗、財宝、微糖、憐憫、噴飯、天道虫、醍醐味、焼却、補う、骨折り損、簫、霊長類、禍々しい、橄欖、炸裂、噤む、雑草、榧、愛猫、派生、延滞、梱包、海豹、菖蒲、生け簀、十六夜、豌豆豆、絡繰り、躱す、雁擬き、秋桜、蒟蒻、茜色、長閑、一弾指、格納、付随、断絶、溺愛、鰧、上諭、託す、ぶち壊す、解明、抜け道、言わしめる、御伽噺、転移、回りくどい、相殺、反動、着地、勿体ぶる、全滅、他言無用、君臨、成し遂げる、偉業、爪痕、盂蘭盆、押捺、淵源、画帖、伽藍鳥、麒麟児、頭をよぎる、レイヤー、睫毛、不審者、裏技、職質、摂氏、良性、マゾヒズム、支障を来す、冷却、誘発、鈍感、血潮、飲食、血糊、着心地、蒸れる、飛び散る、ガン見、紙粘土"
